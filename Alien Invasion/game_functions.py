...
def check_events(ai_settings, screen, stats, scoreboard, play_button, ship, aliens, bullets):
    """
    get information that keyboard is pushed or not
    :param ai_settings: settings of the game
    :param screen: pygame's screen
    :param ship: ship
...
def check_keydown_events(event, ai_settings, screen, ship, bullets):
    ...
    :param event: keyboard from keyboard
    :param ai_settings: game's settings
    """
...
def update_bullets(ai_settings, screen, stats, scoreboard, ship, aliens, bullets):
    ...
    # remove bullets when it hits enemy
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    """
    alien = Alien(ai_settings, screen)
    number_rows = get_number_rows(ai_settings, alien.rect.width)
    number_columns = get_number_columns(ai_settings, ship.rect.height, alien.rect.height)
...
def get_number_rows(ai_settings, alien_width):
    """get number of alien in a row"""
    available_space_x = ai_settings.screen_width - 2 * alien_width
    number_aliens_x = int(available_space_x / 2 / alien_width)
    return number_aliens_x


def get_number_columns(ai_settings, ship_height, alien_height):
    """ get number of alien in a column"""
